...
Has a tendency to make illegal moves on faster time controls however mostly stable at around 5 minutes / 40 moves
Elo also declines sharply at faster time controls
...
Game State: Checkmate, stalemate, insufficient material, 50-move clock
Hashing: Zobrist-like keys for TT and book
Optimizations: Built-in intrinsics, atomic stop flag, depth-priority TT replacement
